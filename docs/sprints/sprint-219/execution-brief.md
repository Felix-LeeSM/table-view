...
- `docs/archives/backlogs/refactoring-candidates-2026-05-06.md` § P10 — `connectionStore` / `schemaStore` 의 toast / session / IPC orchestration 을 use-case hook 으로 점진 이동. § P10 의 명시적 권고: "한 번에 전체 store architecture 를 바꾸지 말고 connection lifecycle 한 흐름씩 이동".
