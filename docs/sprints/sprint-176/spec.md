...
- **Cross-sprint risk**: `it.skip` / `it.todo` skip-zero gate is Phase 13+ policy. Any sprint that adds tests in skipped form (e.g. for SQLite cancel deferred to a future sprint) must register a `[DEFERRED-<ID>]` annotation per `docs/archives/lessons/memory-lessons-2026-05-26/workflow/2026-04-27-phase-end-skip-accountability-gate/memory.md`.
