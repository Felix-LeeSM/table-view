...
본 sprint 는 P11 candidate (`docs/archives/backlogs/refactoring-candidates-2026-05-06.md` §P11) 의 **third step**. Sprint 216 (P11 step 1) 의 SchemaTree.test.tsx (2,891 / 104 cases → 6 axis + helper) 와 Sprint 218 (P11 step 2) 의 QueryTab.test.tsx (2,308 / 80 cases → 6 axis + helper) 의 model implementation 패턴 답습. 후속 P11 step 4-5 (`tabStore.test.ts` 2,234 / `DataGrid.test.tsx` 1,906) 는 별도 sprint candidate.
