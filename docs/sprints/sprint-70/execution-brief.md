...
- Other agents의 in-flight 변경(`postgres.rs`, `Sidebar.tsx`, `query/**`, `ThemePicker.tsx`, `index.css`, `SqlSyntax.tsx`, `sqlTokenize**`, `docs/archives/lessons/memory-lessons-2026-05-26/**`) 건드리지 않음.
