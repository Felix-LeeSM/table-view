...
- `docs/archives/lessons/memory-lessons-2026-05-26/memory.md` (modified) — 건드리지 마라
- `docs/archives/lessons/memory-lessons-2026-05-26/workflow/2026-04-25-multi-sprint-protected-scope-diff/` (untracked) — 건드리지 마라
