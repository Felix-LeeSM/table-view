...
본 sprint 는 P11 candidate (`docs/archives/backlogs/refactoring-candidates-2026-05-06.md` §P11) 의 **first step**. 5개 mega test 중 **`SchemaTree.test.tsx` 만** behavior axis 별로 split, 나머지 4개 (tabStore/QueryTab/StructurePanel/DataGrid) 는 후속 sprint candidate. P10 은 risk 가 더 높아 P11 다음으로 미룸.
