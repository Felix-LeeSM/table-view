...
- `memory/product/memory.md` (NEW)
- `memory/runbook/memory.md` (NEW)
- `memory/runbook/cold-boot/memory.md` (NEW)
- `memory/engineering/conventions/testing-scenarios/mock-scope/memory.md` (NEW)
- `memory/engineering/conventions/refactoring/god-file/memory.md` (NEW)
- `memory/index/by-task.md` (NEW, generated)
- `memory/index/by-surface.md` (NEW, generated)
- `memory/memory.md` (MODIFIED — 30초/5분 path)
- `memory/engineering/conventions/memory.md` (MODIFIED — 금지 사항 일반화)
- `memory/engineering/conventions/testing-scenarios/memory.md` (MODIFIED — P7 예시 + 형식)
