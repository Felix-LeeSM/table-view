...
| `docs/archives/decisions/0011-single-window-stub-for-launcher-workspace/memory.md` | 신규 ADR. single-window stub 채택 + phase 12 이월 결정 동결. |
| `docs/archives/decisions/memory.md` | 인덱스에 ADR 0011 행 추가, `updated: 2026-04-27`. |
