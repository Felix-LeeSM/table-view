...
- `docs/refactoring-candidates.md` § P10 step 3 — connectionStore session persistence 를 use-case hook 으로 이동. 단 step 3 의 4 site 중 read-only `hydrateFromSession` 만 본 sprint scope.
