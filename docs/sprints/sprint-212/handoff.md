...
[`docs/archives/backlogs/refactoring-candidates-2026-05-06.md`](../../archives/backlogs/refactoring-candidates-2026-05-06.md) §P5 가 입력값. P5 step 1 (tests block hoist) 은 사용자 commit `a60074d` 로 완료, step 2 만 잔여.
