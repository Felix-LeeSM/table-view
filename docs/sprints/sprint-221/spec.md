...
본 sprint 는 P11 candidate (`docs/archives/etc/refactoring-candidates.md` §P11) 의 **fourth step**. Sprint 216 (P11 step 1, SchemaTree.test 2,891 / 104 cases → 6 axis + helper) / Sprint 218 (P11 step 2, QueryTab.test 2,308 / 80 cases → 6 axis + helper) / Sprint 220 (P11 step 3, StructurePanel.test 2,156 / 84 cases → 4 axis + helper) 의 model implementation 패턴 답습. 후속 P11 step 5 (`DataGrid.test.tsx` 1,906) 는 별도 sprint candidate.
