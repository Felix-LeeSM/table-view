# Sprint 476 Contract: Elasticsearch/OpenSearch Integration Gate
...
- AC-476-01: Elasticsearch/OpenSearch support claims match tested workflows.
- AC-476-02: Search UI does not rely on RDBMS table assumptions.
- AC-476-03: Destructive requests remain gated.
- AC-476-04: Deferred admin/observability gaps are documented.
