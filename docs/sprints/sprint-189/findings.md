...
로 6 case 를 단언). Sprint 189 가 D-4 (`memory/engineering/conventions/refactoring/lib-hook-boundary/memory.md`)
...
- 영속 표준은 `memory/engineering/conventions/refactoring/` 팔레스로 이전됨
