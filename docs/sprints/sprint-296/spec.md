...
6. ADR 신규: `memory/decisions/0021-coverage-gate-parity/memory.md` —
...
- `memory/decisions/0021-coverage-gate-parity/memory.md`: 신규 ADR.
...
- `scripts/setup.sh`
- `memory/decisions/0021-coverage-gate-parity/memory.md` (신규)
