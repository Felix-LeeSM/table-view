...
8. Static (Generator-recorded, Evaluator re-runs):
   ...
   - File inspection: NEW ADR exists. Command: `test -d docs/archives/decisions/0018-async-cancel-policy && test -f docs/archives/decisions/0018-async-cancel-policy/memory.md && head -30 docs/archives/decisions/0018-async-cancel-policy/memory.md`. Must show frontmatter (`status: Accepted`, `date: 2026-04-30`), the body sections (motivation / decision / per-adapter behavior / trade-offs / reversibility).
   - File inspection: ADR index updated. Command: `grep -n '0018' docs/archives/decisions/memory.md`. Must show a row in the "활성 결정" table for ADR-0018.
...
- Evaluator must cite:
  ...
  - Confirmation that ADR-0018 frontmatter is present and the body covers the four required sections (motivation / decision / per-adapter behavior / trade-offs / reversibility); the ADR index `docs/archives/decisions/memory.md` has a new row.
...
10. `test -d docs/archives/decisions/0018-async-cancel-policy && head -30 docs/archives/decisions/0018-async-cancel-policy/memory.md` — confirm ADR file with frontmatter + sections.
11. `grep -n '0018' docs/archives/decisions/memory.md` — confirm ADR index updated.
...
- Write scope:
  ...
  - `docs/archives/decisions/0018-async-cancel-policy/memory.md` (new ADR)
  - `docs/archives/decisions/memory.md` (index update — add ADR-0018 row)
...
- `docs/archives/decisions/0018-async-cancel-policy/memory.md` exists with the prescribed body sections and frontmatter; ADR index `docs/archives/decisions/memory.md` has a new row.
