...
본 sprint 는 P11 candidate (`docs/refactoring-candidates.md` §P11) 의 **fifth step (last)**. Sprint 216 (P11 step 1) / Sprint 218 (P11 step 2) / Sprint 220 (P11 step 3) / Sprint 221 (P11 step 4) 의 model implementation 패턴 답습. 본 sprint 후 P11 cycle 종료 — `refactoring-candidates.md` 의 §P11 retire 가능. 후속 P11 step 없음.
