...
2. **P11 cycle retire** — Sprint 222 is the final P11 step. The orchestrator can now proceed to retire `docs/archives/etc/refactoring-candidates.md` §P11 in a follow-up ops sprint as noted in the contract Exit Criteria.
