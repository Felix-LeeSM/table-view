...
## Residual Notes
- Generator 가 직접 만든 게 아닌 pre-existing 워크트리 modifications (`docs/archives/lessons/memory-lessons-2026-05-26/memory.md`, `src/components/connection/ConnectionDialog.tsx`) 은 sprint-88 범위 밖. sprint-89 시작 전 baseline 캡처 권고 (findings F-1).
