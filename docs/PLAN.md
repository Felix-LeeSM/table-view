...
| 4 | 229+ | feature | (TBD) | 후보: Phase 27 sprint 4 (Foreign Keys + CHECK/UNIQUE constraints) / Phase 27 sprint 5 (reorder ↑↓ + table-level COMMENT ON TABLE + type coloring + schema picker move) / Phase 26 (Trigger Read+Write) / Phase 13 (PG preview tab parity, multi-window 파트는 e2e 복구 후). |
