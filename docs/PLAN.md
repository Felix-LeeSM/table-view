...
| 9 | 234+ | feature | (TBD) | Sprint 234 — UX 종합 polish (cross-tab visual feedback / reorder ↑↓ / table-level COMMENT / schema picker position move / type combobox color coding / `invalidatePostgresTypesCache` lifecycle wire). |
