...
| 8 | 233+ | feature | (TBD) | Sprint 233 — UPDATE SET column autocomplete + bottom strip syntax highlighting. Sprint 234 — UX 종합 polish (cross-tab visual feedback / reorder ↑↓ / table-level COMMENT / schema picker position move / type combobox color coding / `invalidatePostgresTypesCache` lifecycle wire). |
