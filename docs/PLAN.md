...
| 5 | MySQL-family semantic widening | active follow-up | broader `CALL` args, user variables, routine scripting. `DELIMITER`/`LOAD DATA` 는 현재 explicit unsupported boundary 이며, future work 는 procedure body parser 또는 import UX 를 별도 결정 | `docs/query-language-support.md`, `docs/sprints/sprint-439/` |
