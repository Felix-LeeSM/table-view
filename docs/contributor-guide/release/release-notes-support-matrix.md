...
| MSSQL | Bounded SQL authentication, catalog/query/cancel/tabular runtime, primary-key row edit through frontend SQL batch, bounded structured table/index/constraint DDL including column type/nullability/DEFAULT-constraint edits (#1071), bounded T-SQL editor guardrails, and representative Runtime Happy Path smoke are active. Trigger DDL, raw DDL, SQLCMD/admin/security/backup/jobs/users/roles, broad parser/completion semantics, and full T-SQL semantics remain unsupported. | [`docs/product/README.md`](../../product/README.md), [`known-limitations.md`](../../product/known-limitations.md) |
