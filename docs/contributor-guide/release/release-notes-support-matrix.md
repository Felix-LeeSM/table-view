...
| DuckDB | `.duckdb` file workflow supports connect, catalog/table read, raw SELECT, history evidence, writable DML readback, and read-only rejection. Registered local file analytics remains focused evidence below global query/import/export parity. | [`docs/product/README.md`](../../product/README.md), [`known-limitations.md`](../../product/known-limitations.md) |
