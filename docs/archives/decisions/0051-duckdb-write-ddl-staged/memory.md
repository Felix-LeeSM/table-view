...
- ADR 0046 — data source profile / capability architecture. 본 ADR 은 그 **유보(write/DDL paradigm)를 여는 후속이며 supersede 아님**. 0046 본문 동결 유지.
