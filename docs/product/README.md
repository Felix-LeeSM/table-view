...
- Oracle: bounded catalog/query/cancel/tabular/edit-row runtime support is active
  ...
  database switching (the switch re-dials the stored service name/SID; the
  picker lists the session container plus reachable open PDBs). TNS, wallet-less
