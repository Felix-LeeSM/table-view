...
- Oracle: service-name connection UI/runtime probe plus bounded SELECT query
  ...
  and tabular result envelopes are active. Bounded static SQL editor autocomplete
  vocabulary is active as editor assistance only. SID, TNS alias, wallet/TLS,
  catalog/edit/structured DDL, parser/Safe Mode, runtime fixture/live evidence,
  desktop E2E, and full PL/SQL executable semantics remain deferred.
