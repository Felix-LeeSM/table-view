...
- MSSQL: SQL authentication connection UI/runtime probe, SQL Server version
  ...
  plus cancellation/error surfacing. T-SQL editor completion uses the live
  ...
  E2E, TLS-required workflow evidence, SQLCMD/admin support, and full T-SQL
  semantic parity remain deferred.
...
metadata browse for databases/schemas/tables/views/procedures/functions/columns/
indexes/constraints/FKs 이다. Bounded editor completion 은 curated T-SQL vocabulary,
