...
- Elasticsearch/OpenSearch: embedded fixture-backed Search admin/result
  ...
  parsing, sample documents, cancellation, HTTP error surfacing, and bounded
  Search DSL safety validation for query/filter/aggs/sort/source request shapes
  을 지원한다.
