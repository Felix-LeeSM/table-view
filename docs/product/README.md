...
- Elasticsearch/OpenSearch: embedded fixture-backed Search admin/result
  ...
  parsing, and destructive confirmation gate 를 지원한다. OpenSearch 는
  URL/auth/TLS live
