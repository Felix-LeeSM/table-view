...
- Active connection UI/runtime 대상: PostgreSQL, MySQL, MariaDB, SQLite,
  DuckDB, MongoDB, Redis, Valkey, Elasticsearch, OpenSearch, MSSQL.
...
- MSSQL: SQL authentication connection UI/runtime probe, SQL Server version
  ...
  remain deferred.
- Oracle: declared planned RDBMS identity and static seed contract plus bounded
  static SQL editor autocomplete vocabulary only. connection UI/runtime adapter,
  query/catalog/edit path, parser/Safe Mode, runtime fixture/live evidence,
...
| Oracle | planned declared RDBMS identity only | no active Oracle SQL/PL/SQL parser/runtime safety claim | bounded static SQL editor vocabulary | `oracle` profile/dialect identity exists as capability-empty `declared-rdb`. Static SQL seed contract exists for future promotion, and editor autocomplete can suggest selected Oracle SQL keywords, functions, package symbols, sequences, synonyms, and bind placeholders. Connection UI, runtime adapter, runtime query/catalog/edit, parser/Safe Mode, service/SID/wallet/TNS behavior, runtime fixture/live evidence, desktop E2E, and full PL/SQL executable semantics are not implemented |
...
| Oracle | `e2e/fixtures/seed.oracle.sql` | planned static SQL seed contract only. Bounded static editor autocomplete vocabulary is profile/WASM evidence, not fixture/runtime evidence |
...
Oracle 은 별도의 capability-empty declared RDB identity 다. MSSQL 은 connection plus
bounded query runtime support, bounded editor completion, bounded static parser/Safe
Mode metadata 로 승격됐지만, catalog/edit/runtime Safe Mode/runtime smoke claim 은
아직 없다.
