...
- PostgreSQL is the active query/workbench parity lane. Its current routine
  ...
  and the Explain plan-inspection UI/source label. Installed-extension
  completion, Safe Mode confirmations, DDL structure flows, broader
  history-source coverage, cancellation, ERD, admin, and profiler/activity
