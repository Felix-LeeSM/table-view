...
- Elasticsearch/OpenSearch: embedded fixture-backed Search admin/result
  ...
  contract evidence 다. OpenSearch live delete-by-query planning 은 focused
  evidence 이고, OpenSearch Runtime Happy Path smoke, live delete-by-query
...
Elasticsearch Runtime Happy Path smoke now proves live service connect,
...
smoke, observability, profile/explain request workflow, full language-core
