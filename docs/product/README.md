...
- Oracle: service-name connection UI/runtime probe, bounded SELECT query
  ...
  wallet/TLS, table-data browse, edit, structured DDL, sequence/synonym
  DDL/admin workflows, runtime fixture/live evidence, desktop E2E, and full
  PL/SQL executable semantics remain deferred.
