...
package/admin paths unsupported. Those slices do not create Oracle structured
DDL, sequence/synonym DDL/admin workflows, runtime fixture/live evidence,
