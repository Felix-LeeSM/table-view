...
- MSSQL runtime is limited to SQL authentication connection test, SQL Server
  ...
  full T-SQL semantic completion support. Oracle remains a planned SQL/RDBMS
  runtime identity with bounded static SQL editor autocomplete vocabulary only;
  this does not imply Oracle connection UI, runtime adapter, query, catalog,
