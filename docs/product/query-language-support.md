...
sequences/synonyms, and bounded static SQL editor autocomplete vocabulary for
selected keywords, functions, package symbols, sequences, synonyms, and bind
placeholders. Oracle also has a
...
not create Oracle table-data browse, edit, structured DDL, sequence/synonym
DDL/admin workflows, runtime fixture/live evidence, desktop E2E smoke, or full
...
- MSSQL runtime is limited to SQL authentication connection test, SQL Server
  ...
  static parser/Safe Mode metadata; this does not imply Oracle table-data
  browse, edit/structured DDL, sequence/synonym DDL/admin workflows, runtime
  fixture/live, desktop E2E smoke, or full Oracle SQL/PL/SQL executable semantics.
