...
functions, package symbols, sequences, synonyms, and bind placeholders. Those
slices do not create Oracle query/catalog/edit, parser/Safe Mode, runtime
fixture/live evidence, desktop E2E smoke, or full Oracle SQL/PL/SQL
...
| Oracle SQL | Oracle has service-name connection UI/runtime support plus bounded static Oracle SQL editor autocomplete vocabulary for selected keywords, functions, package symbols, sequences, synonyms, and bind placeholders. Static SQL seed contract still declares future SQL promotion evidence. | Oracle has Lifecycle-only runtime capability. Runtime query/catalog/edit, Oracle SQL/PL/SQL parser/Safe Mode, SID/TNS alias/wallet/TLS behavior, runtime fixture/live evidence, desktop E2E smoke, and full PL/SQL executable semantics remain unsupported. Completion suggestions do not widen runtime Oracle support. |
...
- MSSQL runtime is limited to SQL authentication connection test, SQL Server
  ...
  through service-name connection test plus bounded static SQL editor autocomplete
  vocabulary; this does not imply Oracle query, catalog,
  edit, parser/Safe Mode,
