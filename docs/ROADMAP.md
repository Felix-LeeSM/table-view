...
| RDBMS runtime | 불확실한 paradigm 을 넓히기 전에 PostgreSQL, MySQL, MariaDB, SQLite, DuckDB/file analytics support 를 강하게 만든다. | `docs/product/README.md`, `docs/phases/phase-18.md`, `docs/phases/phase-19.md` |
...
| Operations | Core parity 이후 Explain/activity/stats/server info/profiler surface 를 다룬다. | `docs/RISKS.md`, `docs/product/README.md` |
| Security | Credential/key handling, role/user management, auth mechanism expansion, destructive action policy. | `docs/RISKS.md`, `memory/workflow/grill/security-handoff/memory.md` |
...
| SOT check | `docs/product/README.md`, phase docs, risk docs, memory link 를 업데이트하거나 변경 없음으로 선언. |
