...
| Language core | 가능한 범위에서 Rust/WASM 이 hot-path parse/completion vocabulary, context routing, capability gate 를 소유한다. | `memory/engineering/architecture/query-language/memory.md`, ADR 0045, `docs/reference/query-language-support.md`, `docs/archives/phases/completed/phase-31.md` |
...
6. Parser/Safe Mode/completion support 는 명시돼야 한다. Unsupported syntax 는
   `docs/reference/query-language-support.md` 에 문서화된 경우에만 허용한다.
7. 새 DBMS 는 구현 시작 전
