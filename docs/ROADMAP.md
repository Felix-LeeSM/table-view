...
MSSQL trigger/raw DDL, admin widening, broad parser/completion claim 과 Oracle SID/TNS/wallet/advanced auth,
...
import/export, full profiler/activity parity, role/user/permission UI, broad scripting,
MSSQL trigger/raw DDL, admin widening, DDL/admin smoke, full T-SQL semantics, and Oracle SID/TNS/wallet/TLS/
