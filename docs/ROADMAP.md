...
| H6 smoke matrix | `docs/contributor-guide/testing-and-quality.md` | Current E2E smoke proves PostgreSQL, MySQL, MariaDB, SQLite, and MongoDB journeys only. MSSQL/Oracle and wider candidates have future smoke inventories, not current desktop E2E claims. |
