...
| Search fixture slice | `src-tauri/src/db/search.rs`, `src-tauri/src/db/search_destructive.rs`, `src-tauri/src/db/search_dsl.rs`, `src-tauri/src/db/fixtures.rs`, `src-tauri/tests/fixture_harness.rs`, `src/lib/tauri/search.ts`, `src/components/search/SearchResultView.tsx` | Elasticsearch/OpenSearch fixture-backed result contracts exist. Elasticsearch live HTTP connection/catalog/query exists with backend-bounded Search DSL request validation, OpenSearch live HTTP connection/catalog/query exists with the same bounded parser/safety preflight, and Elasticsearch fixture/live delete-by-query safety plans estimate matching docs before exact-target confirmation. OpenSearch Runtime Happy Path smoke/delete-by-query planning and actual live Search admin execution remain unsupported. |
...
| Search live admin/smoke promotion | `docs/product/query-language-support.md`, `docs/product/known-limitations.md`, `docs/contributor-guide/testing-and-quality.md` | Future promotion must cover OpenSearch Runtime Happy Path smoke, admin destructive policy/delete-by-query planning, observability/error surface, CI fixture/live smoke, and active RDBMS lane freeze. |
...
| Search | Keep actual Elasticsearch/OpenSearch admin execution deferred. Elasticsearch live connection/catalog/query, backend-bounded Search DSL validation, delete-by-query safety planning, and OpenSearch live connection/catalog/query are active; promote broader live HTTP only after OpenSearch Runtime Happy Path smoke, OpenSearch delete-by-query planning, admin execution policy, observability/error surface, editor parser/completion, and product-specific delta contracts are explicit. |
