...
| Parser/completion/runtime non-claim | `docs/product/query-language-support.md`, `docs/product/known-limitations.md` | Deferred language ids, MSSQL runtime/edit/smoke slice, and Oracle #905/#906/#907 runtime/edit/Safe Mode/editor-assistance/smoke slice do not create active structured DDL, admin, full parser/completion promotion, PLSQL, or broader SQL Server/Oracle semantics claims by themselves. Future smoke/runtime widening must land in later source-specific PRs with matching evidence. |
