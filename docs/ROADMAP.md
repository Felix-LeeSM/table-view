...
- 기존 지원 DBMS 하나를 데스크톱 DB 클라이언트 수준의 query/workbench parity 까지 끌어올리는
  ...
  query/catalog/edit/parser/Safe Mode/runtime smoke 는 deferred, Oracle 은 bounded
