...
- 기존 지원 DBMS 하나를 데스크톱 DB 클라이언트 수준의 query/workbench parity 까지 끌어올리는
  ...
  declared-only identity 로 남긴다. SQL Server auth/TDS/T-SQL contract 와 Oracle
...
H6 umbrella closure means MSSQL bounded runtime, declared-only Oracle, wider
