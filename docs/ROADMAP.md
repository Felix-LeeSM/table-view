...
classification, and bounded editor assistance 만 허용한다. MSSQL DDL/admin/runtime
smoke/broad parser/completion claim 과 Oracle SID/TNS/wallet/advanced auth,
structured DDL/raw DDL/admin/full parser/completion promotion/PLSQL/runtime smoke claim 은 각 source 의
...
advanced auth/structured DDL/raw DDL/admin/PLSQL/smoke semantics 는 별도 source-specific evidence
전까지 out of scope 다.
...
| Parser/completion/runtime non-claim | `docs/product/query-language-support.md`, `docs/product/known-limitations.md` | Deferred language ids, MSSQL runtime/edit slice, and Oracle #905/#906 runtime/edit/Safe Mode/editor-assistance slice do not create active structured DDL, admin, full parser/completion promotion, PLSQL, or E2E smoke claims by themselves. Smoke/runtime widening must land in later source-specific PRs with matching smoke evidence. |
| H6 smoke matrix | `docs/contributor-guide/testing-and-quality.md` | Current E2E smoke proves PostgreSQL, MySQL, MariaDB, SQLite, DuckDB `.duckdb`, DuckDB file analytics, MongoDB, Redis, Valkey, Elasticsearch, and OpenSearch journeys only. MSSQL smoke specs/fixtures remain inventory until #907 wires smoke evidence, Oracle smoke specs/fixtures are inventory beyond #905/#906 catalog/query/cancel/tabular/edit-row runtime and Safe Mode/editor-assistance evidence and do not wire routine smoke, and wider candidates have future smoke inventories only. |
...
H6 umbrella closure means MSSQL bounded runtime, Oracle bounded runtime/edit/Safe Mode slice, wider
candidate contracts, and smoke routing are aligned. It does not mean MSSQL
DDL/parser/completion/runtime smoke/admin widening, or Oracle DDL/full-parser-
