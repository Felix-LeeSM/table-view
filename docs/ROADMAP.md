...
| Security | Credential/key handling, role/user management, auth mechanism expansion, destructive action policy. | `docs/RISKS.md`, `.agents/skills/grill-me/SKILL.md` |
