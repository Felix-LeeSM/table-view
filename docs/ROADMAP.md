...
| H3 | DuckDB + file analytics | Local-first file analytics 는 새 paradigm 없이 RDBMS 작업을 확장한다. | `.duckdb` raw SQL, CSV/Parquet/JSON preview basics, and file privacy rule 이 green 이다. |
