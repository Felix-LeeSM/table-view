...
「가변 상태」가 이 규칙의 특수 사례다.

**남긴다** — 판정과 그 사유(무엇을 blocking 으로 봤나, 왜 그렇게 봤나) · 안
고치기로 한 것과 그 사유 · 그 판단이 뒤집히는 조건 · 못 잰 축과 못 잰 사유 ·
게이트와 수용 기준의 통과 여부 · 주장마다 결론인 수치와 그것을 만든 명령 한 줄.
...
**뺄 때 사례와 명제의 짝을 안 끊는다.** 인용을 받치던 문장에서 떼어 옆 문장에
붙이면 받던 쪽은 사례를 잃고 받은 쪽은 자기가 안 세는 것을 센다. 압축은 문장을
줄이는 것이지 인용을 옮기는 것이 아니다 — 아래 「개수 서술」이 그 형태로 걸렸다
(#2427 라운드 1).
...
명령을 다시 돌리면 되살아나지만, 실린 과정은 아무도 안 지운다. **「못 쟀다」는
과정이 아니라 판정이라 여기 안 걸린다** — 빠지면 안 잰 축이 잰 축과 구별되지
않는다.
...
이슈 본문, 종결자의 squash body 가 그 자리다. 역할이 늘면 자리도 는다 — 티켓
저자는 이슈 #2229 의 「범위」에서, 종결자는 PR #2232 의 squash body 에서 걸렸다.
scorecard 의 수는 다음 라운드 저자의 입력이라, 리뷰어가 잘못 센 수가 body 로
옮겨져 다음 라운드에 blocking 으로 돌아온다 (#2218).
