...
| Connection | `ConnectionKind`, required fields, credentials, TLS/auth, file permission scope, unsupported modes |
...
| Docs/memory | product/roadmap/reference/contributor/memory update 또는 no-op rationale |
