...
코드 주석을 쓰고 다듬을 때의 행동 계약이다. 간결 · 출처 포인터 · 메타 금지 · 영어
통일의 축은 2026-09-07 사용자 확정이다. 제거/보존 분류의 SOT 는
...
- 범위: 4번(메타 접두사·서사 제거, 본문 보존), 7번(동일 문장 여러 벌을 한 곳으로
  모으기), 8번(한국어·혼용 주석을 영어로 옮기기).
- 비범위: 한 줄 주석 삭제(1번).
