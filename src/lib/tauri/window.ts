// Per-connection workspace window launcher (Q13).
//
...
//
// Callers (the single-instance plugin shim, the connection dispatch
// UI, etc.) only pass a `connectionId`; the
 ...
 *
 * Per Q13 of the state-management strategy:
