...
export function PinnedRecentSections({
  ...
  // #1738 — Recent moved below the tree; collapsed state now hides it
  // completely (0 shown) instead of leaving the shared 5-row peek. Pass a 0
  // cap so "collapse hides it completely" — the section header + toggle stay,
  // but no rows render until the user expands. (#1309's shared
  // HISTORY_DEFAULT_VISIBLE=5 stays the default for other history surfaces
  // like the query panel.)
