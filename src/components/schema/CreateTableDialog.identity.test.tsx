...
// ── IDENTITY (auto-increment) toggle ──────────────────────────────────
//
// Why these tests exist:
//
// `ColumnDraft` carries an `is_identity` flag plus a per-row "Identity"
// checkbox. When checked, the dialog disables the row's `Nullable` +
// `default value` inputs (the IDENTITY sequence is the default; PG
// forces NOT NULL) and the `buildRequest` payload sets
