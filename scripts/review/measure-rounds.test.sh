...
measure --since 2026-07-24 --until 2026-07-26
...
assert_nth_line 1 "rounds_per_merge=5.5" "head-oid 정의는 같은 커밋의 코멘트를 접는다"
assert_has "round_def=head-oid" "round_def label follows the flag"
assert_has "rounds_per_merge_by_def=comments:8.17 head-oid:5.5" "head-oid 모드도 두 정의를 다 낸다"
assert_has "rounds=33" "head-oid 라운드 합 (comments 49 대비 16 감소)"

echo "window:"

measure --since 2026-07-25 --until 2026-07-26
assert_has "prs=13 merged=6 closed=7 open=0 rounds=49" "until 은 제외 경계"
...
measure --since 2026-07-25 --until 2026-07-26
assert_has "round_gap_hours=p50:0.49 p90:36.52 max:43.08 n=36" "공백 분포"
assert_nth_line 12 "  slowest_gap #1800 43.08h  2026-07-25T09:41:33Z -> 2026-07-27T04:46:31Z" "가장 긴 공백이 맨 위"
assert_nth_line 13 "  slowest_gap #1825 36.8h  2026-07-25T15:58:37Z -> 2026-07-27T04:46:38Z" "두 번째로 긴 공백이 그다음"
...
assert_has "  2026-07-25  prs=13 merged=6 rounds=49 rounds_per_merge=8.17 merge_rate=46.2%" "일자별 시계열이 붕괴일을 드러낸다"
assert_has "  2026-07-24  prs=36 merged=33 rounds=50 rounds_per_merge=1.52 merge_rate=91.7%" "정상일도 같은 줄 형식"
measure --since 2026-07-24 --until 2026-07-27 --no-by-day
assert_lacks "by_day" "--no-by-day"
measure --since 2026-07-25 --until 2026-07-26
assert_has "  bash scripts/review/measure-rounds.sh --since 2026-07-25 --until 2026-07-26 --round-def comments" "출력이 자기 재현 명령을 포함한다"
