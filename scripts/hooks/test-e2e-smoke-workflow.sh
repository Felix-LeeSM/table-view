...
assert_contains "$smoke_block" "cargo install tauri-driver --version \${{ env.TAURI_DRIVER_VERSION }} --locked" "tauri-driver cache"
assert_contains "$smoke_block" "Verify tauri-driver version" "tauri-driver cache"
assert_contains "$smoke_block" "tauri-driver --version" "tauri-driver cache"
