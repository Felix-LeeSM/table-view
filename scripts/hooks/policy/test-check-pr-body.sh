...
CHECKER="$ROOT/scripts/hooks/policy/check-pr-body.mjs"
...
- scripts/hooks/policy/check-pr-body.mjs
- scripts/hooks/policy/test-check-pr-body.sh
...
- bash scripts/hooks/policy/test-check-pr-body.sh
