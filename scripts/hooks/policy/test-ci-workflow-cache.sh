...
assert_contains "$pr_body_block" "run: bash scripts/hooks/policy/test-check-pr-body.sh" "PR body job"
assert_contains "$pr_body_block" "run: node scripts/hooks/policy/check-pr-body.mjs" "PR body job"
...
assert_contains "$dependency_security_block" "bash scripts/hooks/apply/cargo-deny-summary.sh" "dependency security summary"
...
assert_contains "$changes_block" "run: bash scripts/hooks/analyze/detect-change-scope.sh" "changes job detection script"
