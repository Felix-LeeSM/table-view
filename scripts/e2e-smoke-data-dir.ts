 ...
 *
 * #1836: `scripts/e2e-smoke-ci.sh` wipes the data dir once per *spec file*, but
 ...
 *   sibling `<dataDir>-fixtures` (scripts/fixtures/paths.ts,
 *   e2e/smoke/_helpers.ts `smokeFixtureRoot`, #1449) hold prepared file-DB
 *   fixtures built once per job and must survive.
