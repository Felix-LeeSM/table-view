...
Your findings output should be directly transposable into `.codex/skills/harness/templates/findings.md`.
Your final summary should also provide the evidence fields needed by `.codex/skills/harness/templates/handoff.md`.
