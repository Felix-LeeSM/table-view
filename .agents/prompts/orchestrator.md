...
pass 종료 시: `spawn: [...] / 머지: [...] / 대기: [...] / 정지: [...]` 각 항목 한 줄.
서사 없이 상태만. **머지 칸은 이 pass 에 돌아온 종결자 반환의 첫 줄
(`- PR: #<번호> — merged <머지 SHA> (squash)`)을 그대로 옮긴다.** 그 칸이 왜 있는지,
무엇까지만 옮기는지, 값의 출처를 상태 수집으로 바꾸지 않는 이유는
`memory/workflow/orchestration/memory.md` §7 이 SOT 다.
