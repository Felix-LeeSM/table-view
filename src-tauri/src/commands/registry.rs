...
pub fn register_all(builder: tauri::Builder<tauri::Wry>) -> tauri::Builder<tauri::Wry> {
    builder.invoke_handler(tauri::generate_handler![
        ...
        commands::persist_snippets::persist_snippets,
        commands::persist_snippets::list_snippets,
        ...
        commands::rdb::value_search::pg_search_values,
        ...
        commands::kv::execute_kv_command,
        ...
        commands::export::session::export_grid_begin,
        commands::export::session::export_grid_chunk,
        commands::export::session::export_grid_finish,
        commands::export::session::export_grid_abort,
        ...
        commands::import_csv::build_csv_import_statements,
        // Window commands
