...
- **MSSQL**: 알려진 planned DBMS identity지만 현재 runtime adapter는 없습니다. 기본 dev/e2e fixture connection으로 추가되지 않습니다.
...
MSSQL은 planned DBMS identity와 seed contract 검증용 컨테이너입니다.
