...
- **[`docs/refactoring-smells.md`](docs/refactoring-smells.md)** — 코드 smell 9 카테고리 카탈로그 (시한부, 2026-05-02 frozen snapshot — Sprint 198 종료 후 retire).
- **[`docs/refactoring-plan.md`](docs/refactoring-plan.md)** — Sprint 189–198 의 10단계 sequencing (시한부 — Sprint 198 종료 후 retire).
