...
> generating, or refactoring React codebases at Vercel. Humans  
...
3. [Server-Side Performance](#3-server-side-performance) — **HIGH**
   ...
   - 3.5 [Use Non-Blocking Operations for Side Effects](#35-use-non-blocking-operations-for-side-effects)
...
Reference: [https://github.com/jshttp/on-finished](https://github.com/jshttp/on-finished), [https://nodejs.org/en/docs/guides/event-loop-timers-and-nexttick](https://nodejs.org/en/docs/guides/event-loop-timers-and-nexttick)
